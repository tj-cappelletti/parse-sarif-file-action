...
test('test runs', () => {
  ...
  process.env['INPUT_sarifFile'] = path.join(__dirname, "sarif-files", "sarif-with-error-results.json");
  ...
  console.log(childProcess.execFileSync(nodePath, [mainJsFile], options).toString())
})
